...
use app\models\Sayurbuahsetahunsearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * SayurbuahsetahunController implements the CRUD actions for Sayurbuahsetahun model.
 */
class SayurbuahsetahunController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Displays a single Sayurbuahsetahun model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new Sayurbuahsetahun model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new Sayurbuahsetahun();
    ...
    /**
     * Updates an existing Sayurbuahsetahun model.
    ...
    /**
     * Deletes an existing Sayurbuahsetahun model.
    ...
    /**
     * Finds the Sayurbuahsetahun model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Sayurbuahsetahun the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Sayurbuahsetahun::findOne($id)) !== null) {
            return $model;
        } else {
