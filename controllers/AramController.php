...
use Yii;
use app\models\Aram;
use app\models\Aramsearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * AramController implements the CRUD actions for Aram model.
 */
class AramController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    public function actionImport()
    {
        ...
        if (Yii::$app->request->post()) {
			...
			return $this->redirect(['aram/index']);
        }
    ...
    /**
     * Lists all Aram models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new Aramsearch();
        $tahun = date('Y');
        $wil = '1601';

        if (Yii::$app->request->post()) {
            $tahun = $_POST['Aramsearch']['id_tahun'];
            $wil = $_POST['Aramsearch']['id_wil'];
        }
    ...
    /**
     * Updates an existing Aram model.
    ...
    /**
     * Deletes an existing Aram model.
    ...
    /**
     * Finds the Aram model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Aram the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Aram::findOne($id)) !== null) {
            return $model;
        } else {
