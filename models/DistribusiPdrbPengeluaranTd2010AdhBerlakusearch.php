...
/**
 * DistribusiPdrbPengeluaranTd2010AdhBerlakusearch represents the model behind the search form about `app\models\DistribusiPdrbPengeluaranTd2010AdhBerlaku`.
 */
class DistribusiPdrbPengeluaranTd2010AdhBerlakusearch extends DistribusiPdrbPengeluaranTd2010AdhBerlaku
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = DistribusiPdrbPengeluaranTd2010AdhBerlaku::find();
