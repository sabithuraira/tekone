...
/**
 * This is the model class for table "laju_pertumbuhan_indeks_implisit".
 *
 * @property integer $id
 * @property double $a
 * @property double $b
 ...
 */
class LajuPertumbuhanIndeksImplisit extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'laju_pertumbuhan_indeks_implisit';
    }
