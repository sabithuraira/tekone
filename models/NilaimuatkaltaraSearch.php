...
/**
 * Nilaimuatkaltarasearch represents the model behind the search form about `app\models\Nilaimuatkaltara`.
 */
class Nilaimuatkaltarasearch extends Nilaimuatkaltara
{
    /**
     * @inheritdoc
     */
