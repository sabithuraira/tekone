...
/**
 * Nilaibongkarkaltarasearch represents the model behind the search form about `app\models\Nilaibongkarkaltara`.
 */
class Nilaibongkarkaltarasearch extends Nilaibongkarkaltara
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = Nilaibongkarkaltara::find();
