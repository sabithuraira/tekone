...
/**
 * Nilaimuatkaltimsearch represents the model behind the search form about `app\models\Nilaimuatkaltim`.
 */
class Nilaimuatkaltimsearch extends Nilaimuatkaltim
{
    /**
     * @inheritdoc
     */
