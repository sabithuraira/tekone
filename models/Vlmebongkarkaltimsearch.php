...
/**
 * Vlmebongkarkaltimsearch represents the model behind the search form about `app\models\Vlmebongkarkaltim`.
 */
class Vlmebongkarkaltimsearch extends Vlmebongkarkaltim
{
    /**
     * @inheritdoc
     */
