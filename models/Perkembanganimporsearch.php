...
/**
 * Perkembanganimporsearch represents the model behind the search form about `app\models\Perkembanganimpor`.
 */
class Perkembanganimporsearch extends Perkembanganimpor
{
    /**
     * @inheritdoc
     */
