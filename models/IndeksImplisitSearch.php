...
/**
 * IndeksImplisitSearch represents the model behind the search form about `app\models\IndeksImplisit`.
 */
class IndeksImplisitSearch extends IndeksImplisit
{
    /**
     * @inheritdoc
     */
