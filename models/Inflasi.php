...
/**
 * This is the model class for table "inflasi".
 *
 * @property integer $id
 * @property double $bahanmakanan
 * @property double $padipadianumbiumbianhasilnya
 * @property double $daginghasilhasilnya
 ...
 */
class Inflasi extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'bahanmakanan' => 'Bahan makanan',
            'padipadianumbiumbianhasilnya' => 'Padi-padian umbi-umbian hasilnya',
            'daginghasilhasilnya' => 'Daging hasil hasilnya',
            'ikansegar' => 'Ikansegar',
