...
/**
 * PdrbPengeluaranTd2010AdhBerlakusearch represents the model behind the search form about `app\models\PdrbPengeluaranTd2010AdhBerlaku`.
 */
class PdrbPengeluaranTd2010AdhBerlakusearch extends PdrbPengeluaranTd2010AdhBerlaku
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = PdrbPengeluaranTd2010AdhBerlaku::find();
