...
/**
 * PertumbuhanPdrbPengeluaranTd2010AdhKonstanYtoysearch represents the model behind the search form about `app\models\PertumbuhanPdrbPengeluaranTd2010AdhKonstanYtoy`.
 */
class PertumbuhanPdrbPengeluaranTd2010AdhKonstanYtoysearch extends PertumbuhanPdrbPengeluaranTd2010AdhKonstanYtoy
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = PertumbuhanPdrbPengeluaranTd2010AdhKonstanYtoy::find();
