...
/**
 * Vlmemuatkaltarasearch represents the model behind the search form about `app\models\Vlmemuatkaltara`.
 */
class Vlmemuatkaltarasearch extends Vlmemuatkaltara
{
    /**
     * @inheritdoc
     */
