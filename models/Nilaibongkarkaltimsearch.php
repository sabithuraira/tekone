...
/**
 * Nilaibongkarkaltimsearch represents the model behind the search form about `app\models\Nilaibongkarkaltim`.
 */
class Nilaibongkarkaltimsearch extends Nilaibongkarkaltim
{
    /**
     * @inheritdoc
     */
