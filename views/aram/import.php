...
<div class="box box-default">
	<div class="box-header with-border"><h3 class="box-title">
		<span class="fa fa-upload"></span> Input Data ARAM</h3>
	</div>
	...
	<div class="box-body">	
		<div class="body-content">
			...
			<div class="row">
				...
				<div class="col-xs-3 col-md-3"><?= Html::a('Download Tamplate', \yii\helpers\Url::to('@web/excel/aram.xlsx') ,['style'=> 'vertical-align:middle',]) ?></div>
				<div class="col-xs-3 col-md-3"></div>
			</div>
